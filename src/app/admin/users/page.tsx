  ...
  return <main className="min-h-screen bg-white">
    ...
    <section className="md:ml-64">
      <header className="flex items-center justify-between gap-4 border-b bg-white px-4 py-5 md:px-10">
        <div>
          <p className="text-xs font-bold tracking-widest text-[#ef6c3d] uppercase">Team</p>
          <h1 className="mt-1 text-2xl font-black">จัดการผู้ใช้</h1>
        </div>
      ...
      <div className="max-w-4xl p-4 sm:p-6 md:p-10">
        <UserManager currentAdminId={admin.id} isBootstrap={admin.isBootstrap}/>
      </div>
    </section>
  </main>;
}
